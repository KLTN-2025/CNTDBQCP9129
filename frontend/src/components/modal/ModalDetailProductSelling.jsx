...
const ModalDetailProductSelling = ({
  ...
  return (
    ...
    >
      <div className="relative rounded-2xl w-full bg-gradient-to-b bg-amber-100 to-white max-md:flex-col flex select-none">
         <div className="flex flex-col w-full pl-10 pb-10">
            <img src={selectedProduct.image} className="object-cover w-[400px] h-[500px]" alt={selectedProduct.name} />
        ...
        <div className="w-full px-6 pt-20">
          ...
          <p className="text-2xl font-bold text-orange-400 mt-6">{formatCurrencyVN(selectedProduct.price)}</p>
          <p className="text-xl mt-6">{selectedProduct.description}</p>
          <button className="bg-orange-500 rounded-full text-white text-xl font-bold mt-10 cursor-pointer px-12 py-4"
